...
function UserProfile() {
    return (
      <div className="bg-gray-100 p-8 max-w-sm mx-auto my-20 hover:shadow-xl rounded-lg shadow-lg sm:p-4 md:p-8 sm:max-w-xs md:max-w-sm">
        <img className="rounded-full w-36 h-36 mx-auto hover:scale-110 transition-transform duration-300 ease-in-out sm:w-24 sm:h-24" src="https://via.placeholder.com/150" alt="User" />
